<div class="card">
    ...
    <div class="card-body">
        <button wire:click="create()" class="btn btn-outline-primary">Nuevo Proveedor</button>
        @if($isOpen)
        <div class="classModal">
            @include('livewire.suppliers-create')
        </div>
        @endif
    </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">{{ $supplier->social_reason }}</td>
                    <td class="border px-4 py-2">{{ $supplier->cuil }}</td>
                    <td class="border px-4 py-2">{{ $supplier->domicile }}</td>
                    <td class="border px-4 py-2 action-column">
                        <div class="action-buttons">
                            <button wire:click="edit({{ $supplier->id }})" class="btn btn-outline-primary">Editar</button>
                        </div>
                    </td>
                </tr>
                @endforeach
